...
const nextConfig: NextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'qupid-app.onrender.com',
        pathname: '/uploads/**',
      },
      {
        protocol: 'https',
        hostname: 'qupid-api.onrender.com',
        pathname: '/uploads/**',
      },
    ],
        ...
        headers: [
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: http://localhost:8000 https: blob:; connect-src 'self' http://localhost:8000 ws://localhost:8000 https://api.qupid.app https://qupid-api.onrender.com https://qupid-app.onrender.com wss://api.qupid.app wss://qupid-api.onrender.com wss://qupid-app.onrender.com https://fonts.googleapis.com https://fonts.gstatic.com;",
          },
          {
